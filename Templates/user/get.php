                                ...
                                <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th style="text-align: center;" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Số dư</th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <span class="badge bg-danger">
                                                    <a href="?controller=user&action=delete&userId=<?=$user['id']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa');">
